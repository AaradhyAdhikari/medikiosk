...
const SHELL = [
  ...
  "/manifest.webmanifest", "/icons/icon-192.png", "/icons/icon-512.png", "/icons/icon-64.png", "/icons/mark.png", "/icons/wordmark.png",
  "/img/body-front.png", "/img/body-back.png", "/img/body-front-f.png", "/img/body-back-f.png",
];
